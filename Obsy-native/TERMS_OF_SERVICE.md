...
By using Obsy ("the App"), you agree to these Terms of Service ("Terms"). If you don't agree, don't use the App.
...
- Billed monthly or annually via App Store / Google Play
- Auto-renews unless cancelled 24 hours before renewal
- No refunds for partial billing periods
- You can cancel anytime in your device's subscription settings
...
### What They Are
Obsy uses AI (Google Gemini) to generate reflective insights based on your captures, moods, and journal entries.

### What They Aren't
- **Not therapy.** Obsy is not a mental health service.
- **Not medical advice.** Don't use insights for health decisions.
- **Not always accurate.** AI can misinterpret, hallucinate, or produce unexpected results.
...
### No Guarantees
We strive for 99.9% uptime but don't guarantee it. The App may be:
...
### By You
You can delete your account anytime. This removes all your cloud data.
...
### "As Is" Service
Obsy is provided "as is" without warranties of any kind. We don't guarantee:
- Uninterrupted service
- Error-free operation
- That insights will be accurate or useful
