...
function buildMonthlyPrompt(input: {
  ...
  return [
    ...
    "  Under 10 captures: 1 short paragraph, 60-90 words max. Treat it like a snapshot, not a narrative.",
    "  10-20 captures: 2 paragraphs, 100-140 words max.",
    "  20-40 captures: 2-3 paragraphs, 140-180 words max.",
    "  40+ captures: 3 paragraphs, 180-220 words max.",
    "  The closing observation is always the final sentence of the last paragraph regardless of length.",
    "  CRITICAL: If the data is sparse, do not stretch. A month with 8 captures deserves a tight, pointed read, not three paragraphs of filler. Fewer words with more punch always beats more words with less substance. Match the density of the writing to the density of the data.",
    "  Prose only, no markdown or bullets.",
